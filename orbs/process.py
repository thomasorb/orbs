...
class RawData(InterferogramCube):
    ...
    def _load_bias(self, bias_list_path, return_temperature=False,
        ...
        if self.has_same_2D_size(bias_cube):
    ...
    def _load_dark(self, dark_list_path, return_temperature=False,
        ...
        if self.has_same_2D_size(dark_cube):
        ...
        # Write master dark
        orb.utils.io.write_fits(self._get_master_path('dark'), master_dark,
    ...
    def _load_flat(self, flat_list_path, combine='average', reject='avsigclip',
        ...
        if self.has_same_2D_size(flat_cube):   
    ...
    def get_noise_values(self, bias_path, dark_path,
        ...
        if not self.has_same_2D_size(dark_cube):
        ...
        for ik in range(z_min, z_max, ncpus):
            ...
            for ijob, job in jobs:
                ...
                out_cube.write_frame(
                    ik+ijob,
                    data=iframe,
                    header=self.get_frame_header(ik+ijob),
                    mask=imask_frame,
                    record_stats=True)
